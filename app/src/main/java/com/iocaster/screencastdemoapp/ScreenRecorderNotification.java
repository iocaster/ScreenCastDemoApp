...
public class ScreenRecorderNotification {
     ...
     */
    private static final String NOTIFICATION_TAG = "ScreenRecorderNotification";
    ...
    public static void notify(final Context context,
        ...
        final Bitmap picture = BitmapFactory.decodeResource(res, R.drawable.iocaster_logo);
                ...
                .setContentIntent(
                        PendingIntent.getActivity(
                                ...
                                new Intent(context, MainActivity2.class)
                                        /* To prevent opening Activity multiple-times : */
                                        /*.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_SINGLE_TOP)*/
                                        /*.setFlags(Intent.FLAG_ACTIVITY_REORDER_TO_FRONT)*/
                                        /* Instead, use this option in manifest : android:launchMode = "singleInstance" */
                                ,
